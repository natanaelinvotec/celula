...
- Um exame por item, EXCETO termos compostos que o laboratório abre sozinho: "ferrograma", "lipidograma"/"perfil lipídico", "hepatograma"/"função hepática", "ionograma"/"eletrólitos", "proteinograma", "coagulograma" e outros terminados em "-grama" devem vir como UM item, com "normalizado" igual ao próprio termo (ex.: "Ferrograma" -> "FERROGRAMA"). "função renal" vira UREIA e CREATININA.
